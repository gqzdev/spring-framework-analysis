...
public abstract class AnnotationConfigUtils {
	...
	//AnnotationConfigUtils类的processCommonDefinitionAnnotations在向容器注册Bean之前，
	// 首先对注解Bean定义类 中的通用Spring注解进行处理
	...
	static BeanDefinitionHolder applyScopedProxyMode(
		...
		//获取配置的@Scope注解的proxyMode属性值，
		// 如果为TARGET_CLASS则返回true，如果为INTERFACES，则返回false
